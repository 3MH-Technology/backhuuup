...
SYSTEM_PROMPT = (
    ...
    "اسم المطور: الذئب الأبيض 🐺. تيليجرام: @j49_c. القناة: https://t.me/EQJ_1. الدعم: @Wolfhost_1. إكس: @wolfhost_1. "
    ...
    "البوت يتصل بتليجرام تلقائياً — ما يحتاج أي إعدادات بروكسي أو DNS. فقط اكتب كودك بشكل طبيعي. "
